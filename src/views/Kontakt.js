    ...
    return (
      <section className='kontakt'>
        ...
        <ul className="wrapper">
          ...
          <li><a href="https://www.facebook.com/hrefbias.lines/"><i className="fab fa-facebook-square fa-2x"></i></a></li>
          <li><a href="https://www.instagram.com/caruso333/"><i className="fab fa-instagram fa-2x"></i></a></li>
          <li><a href="https://www.linkedin.com/in/hrefbias-lein%C3%9F-422306a9/"><i className="fab fa-linkedin fa-2x"></i></a></li>
          ...
          <li><a href='mailhref:leinsst@web.de'><i className="fas fa-envelope fa-2x"></i></a></li>
        </ul>
      </section>
    );
  }
