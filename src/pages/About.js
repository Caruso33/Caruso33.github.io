  ...
  return (
    <>
      <div>
        ...
        <p>
          Currently, I work as a Senior Web Developer. I enjoy writing code and
      ...
      <div>
        ...
        <p>
          ...
          with{" "}
          <a href="https://facebook.github.io/react-native/">React-Native.js</a>
          .
        </p>
        <p>
          Build a{" "}
          <span className="linkColor">solid website infrastructure</span> using
          widely accepted design languages
        </p>
        <p>
        ...
        <p>
          Making websites PWA <span className="linkColor">mobile-ready</span> as
          taught by Google and Udacity by the
          <br />
          <span className="linkColor">Mobile Web Specialist Nano-degree</span>
        </p>
        <p>
          I was recipient of{" "}
        ...
        <p>
          {" "}
          If you are unsure if I can help you, just send me a message to see if
