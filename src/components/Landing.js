            ...
            >
              ...
              <CardContent xs={12} sm={6}>
                <ExpansionPanel className={classes.Panel}>
                  ...
                  <ExpansionPanelDetails>
                    <Typography>
                      I build a landing page, portfolio-page, contact-page,
                      blog, etc. from ground up
                    </Typography>
                  </ExpansionPanelDetails>
                </ExpansionPanel>
                <ExpansionPanel className={classes.Panel}>
                  ...
                  <ExpansionPanelDetails>
                    <Typography>
                      I enhance your website with authentification, payments,
                      etc.
                    </Typography>
                  </ExpansionPanelDetails>
                </ExpansionPanel>
                <ExpansionPanel className={classes.Panel}>
                  ...
                  <ExpansionPanelDetails>
                    <Typography>
                      I mainly use reactjs on the frontend side, nodejs &
                      express on the backend and mongodb as database of choice.
  ...
  /> */}
              <CardContent>
                ...
                <Typography
                  ...
                  style={{ marginTop: 10 }}
                >
                  Overall, I am more than willed to get things done,
                  successfully and in a compassionate manner.
                </Typography>
                <Typography
                  variant="subheading"
                  component="p"
                ...
                >
                  ...
                  you, just send me a message to see if it's something I can do.
                  I usually respond within one hour and promise to get back to
                  you within 12 hours.
                </Typography>
              </CardContent>
            </Card>
            ...
            >
              <CardContent>
                ...
                >
                  ...
                  with my girlfriend. I am enjoying the combination of working
                  on my laptop and traveling on free time so much that I decided
                  to sell most of my things back home in Germany in order to
                  pursue this life.
                </Typography>
                <Typography
                  variant="subheading"
                  ...
                  style={{ marginTop: 10 }}
                >
                  If you have ANY questions, don't hesitate to send me a
                  message.
                </Typography>
                <Typography
                  variant="subheading"
